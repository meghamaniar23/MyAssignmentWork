...
public class PopularDealsFragment extends BaseFragment implements TopFragmentPresenter.UpdateView {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        topFragmentPresenter = new TopFragmentPresenter(activity, this, 1, Const.CATEGORY_POPULAR_DEALS);

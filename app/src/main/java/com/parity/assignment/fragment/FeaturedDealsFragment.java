...
public class FeaturedDealsFragment extends BaseFragment implements TopFragmentPresenter.UpdateView {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        topFragmentPresenter = new TopFragmentPresenter(activity, this, 2, Const.CATEGORY_FEATURED_DEALS);
    ...
    public void onGetTopDeals(ArrayList<DealsData> topDealsList) {
        ...
        if(dealsAdapter == null){
            ...
            dealsAdapter.notifyItemInserted(topDealsList.size() - 1);
        }
    }
